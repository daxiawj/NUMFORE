...
!*********************************************************!
!
! V-0.4 2008-12-31 改编码为UTF-8
!
! V-0.5 2011-08-29 改输入输出为stream，替换坑爹的dicrect，以提高不同系统里的兼容性
!
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!输出看看原始场
open(1,file='inituvz.dat',form='unformatted',access='stream')
  write(1)((u(i,j,k),i=1,m),j=1,n)
  write(1)((v(i,j,k),i=1,m),j=1,n)
  write(1)((h(i,j,k),i=1,m),j=1,n)
close(1)
!!!!!!!开始积分
...
open(1,file='date.dat',form='unformatted',access='stream')
